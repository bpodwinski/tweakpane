import type {Controller, Value, ViewProps} from 'tweakpane-reborn-core';
...
export class RotationInputSwatchController
	implements Controller<RotationInputSwatchView>
{
